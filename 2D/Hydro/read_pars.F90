...
#include "definition.h"
  ...
  call read_initFileBool('slug.init','sim_GPFlux',sim_GPFlux)
  call read_initFileBool('slug.init','sim_DongwookFlux',sim_DongwookFlux)
  call read_initFileBool('slug.init','sim_hdf5',sim_hdf5)
  sim_AO = .false.
  call read_initFileBool('slug.init','sim_AO',sim_AO)

  sim_reconMultiD = .false.
  call read_initFileBool('slug.init','sim_reconMultiD',sim_reconMultiD)
  call read_initFileBool('slug.init','sim_intFlux',sim_intFlux)
...
!!$  call read_initFileReal('slug.init','sim_RQ_alpha',  sim_RQ_alpha)
  ...
  !read grid data
  allocate(gr_xend(2)); allocate(gr_xbeg(2))
  ...
  call read_initFileReal('slug.init','gp_sigdel' ,  gp_sigdel )
