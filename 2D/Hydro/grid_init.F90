...
#include "definition.h"
  ...
  allocate(gr_W(NSYS_VAR,gr_imax(XDIM),gr_imax(YDIM))); gr_W = 0. !is this even used???
  allocate(gr_betas(NSYS_VAR,gr_imax(XDIM),gr_imax(YDIM),NDIM)); gr_betas=0.
  ...
  allocate(gr_flux(NSYS_VAR,gr_imax(XDIM),gr_imax(YDIM),NDIM)); gr_flux = 0. !(var,i,j,dir)
  allocate(gr_ptFluxes(NSYS_VAR,gr_imax(XDIM),gr_imax(YDIM),NDIM)); gr_ptFluxes = 0.
