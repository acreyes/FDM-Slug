...
#include "definition.h"
  ...
  real, save :: gp_el, gp_eldel, gpM_radius , gp_Xdel, gp_Ydel, gp_sigdel
...
!  real(KIND=16), save :: gp_Xdel, gp_Ydel
  ...
  real(KIND=8),  allocatable, dimension(:,:) ::  gp_wR
  real(KIND=8),  allocatable, dimension(:  ) :: gp_U2

  !Adaptive Order
  real(KIND=8), save :: gpA_det, gpA_det5, gp_det
  real(KIND=8), allocatable, dimension(:,:)   :: gpA_z, gpA_z5
  real(KIND=8), allocatable, dimension(:,:) :: gpA_Pvecs, gpA_Pvecs5
