...
!!$             abs(smth_ind(3)-smth_ind(1))/(sim_WENeps + smth_ind(s)))**sim_mval
     ...
     do s = 1, R+1
        ENO_intp(s,1) = dot_product(gp_zk(2,1:R+1,R+2-s), stencil(s+R:s:-1))
